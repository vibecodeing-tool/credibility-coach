            ...
            <div className="border-t pt-3">
              ...
              >
                {showAnswer ? (
                  ...
                  <><Eye className="mr-1.5 h-3.5 w-3.5" /> Peek reference answer</>
                )}
              </Button>
              {showAnswer && (
                <div className="mt-2 max-h-56 overflow-y-auto rounded-md border bg-muted/40 p-3 text-sm whitespace-pre-wrap break-words">
                  {question.answer?.trim() ? question.answer : (
                    <span className="text-muted-foreground italic">No reference answer available.</span>
                  )}
                </div>
